<template>
  <nav class="navigation-rail glass-strong">
    <div class="navigation-rail__header">
      <div class="logo">
        <svg class="logo__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" opacity="0.4"/>
    ...
    <div class="navigation-rail__items">
      ...
      >
        <svg class="navigation-rail__item-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="navigation-rail__bottom">
      ...
      <button
        ...
        title="Войти"
      >
        <svg class="navigation-rail__item-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4"/><path d="M10 17l5-5-5-5"/><path d="M15 12H3"/></svg>
